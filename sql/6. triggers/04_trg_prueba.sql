-- Obtenemos un pedido y un producto existentes para respetar las claves foráneas.
SET @test_order_key =
(
    SELECT order_key
    FROM orders
...
-- Generamos temporalmente un source_row_id que no exista en order_details.
...
-- Verificamos el registro generado automáticamente por el trigger.
SELECT
    audit_id,
    table_name,
    record_key,
...
-- Revertimos la línea de prueba y su correspondiente auditoría.
ROLLBACK;
