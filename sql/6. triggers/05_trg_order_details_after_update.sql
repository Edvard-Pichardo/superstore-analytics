/*
Archivo      : 05_trg_order_details_after_update
Proyecto     : superstore-analytics
Autor        : Cristian Eduardo Pichardo Rico
Descripción  : Registra automáticamente en audit_log los cambios realizados sobre las líneas de
               pedido, conservando el estado anterior y posterior a cada modificación.
*/
