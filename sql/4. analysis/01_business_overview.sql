/*
Archivo      : 01_business_overview
Proyecto     : superstore-analytics
Autor        : Cristian Eduardo Pichardo Rico
Descripción  : Resumen general de KPI:
               Consulta ejecutiva de los principales indicadores generales del negocio.
*/

USE superstore_analytics;

-- Presentamos los principales indicadores comerciales, operativos y de calidad de datos del negocio.
SELECT
    -- Periodo analizado.
    first_order_date,
    last_order_date,
