/*
Archivo      : 05_subcategory_analysis
Proyecto     : superstore-analytics
Autor        : Cristian Eduardo Pichardo Rico
Descripción  : Análisis comparativo del desempeño de las subcategorías de productos, considerando
               ventas, beneficio, margen, participación y cobertura de información.
*/
...
-- Participación dentro de su propia categoría.

-- También conservamos indicadores de cobertura para  interpretar correctamente las métricas obtenidas.
...
SELECT
    ...
    -- Se convierten a SIGNED porque DENSE_RANK()devuelve valores BIGINT UNSIGNED.
...
-- Analicemos el alto volumen frente a rentabilidad de cada producto.
-- Comparamos cada subcategoría contra dos referencias:
-- Venta promedio entre todas las subcategorías.
-- Margen comparable promedio entre todas las subcategorías.
...
SELECT
    ...
    -- Diferencia respecto a la venta promedio de las subcategorías.
    ROUND(
    ...
    -- Diferencia en puntos porcentuales respecto al margen promedio.
    ROUND(
        comparable_profit_margin_percentage
        -
        average_subcategory_margin,
    ...
    -- Porcentaje de líneas con beneficio conocido cuyo resultado fue negativo.
    ROUND(
        100.0
        *
        loss_making_lines
...
-- Ordenamos las subcategorías desde la de mayores ventas hasta la de menores ventas y calculamos:
-- Participación individual sobre las ventas.
-- Ventas acumuladas.
-- Participación acumulada.
-- Clasificación ABC basada en concentración.
...
SELECT
    ...
    -- Clasificación basada en la concentración acumulada de las ventas.
    CASE
...
-- Cantidad de subcategorías necesarias para concentrar diferentes porcentajes de las ventas
...
SELECT
    -- Número mínimo aproximado de subcategorías necesarias para alcanzar cada umbral.
    MIN(
        CASE
...
-- Subcategorías con mayor riesgo de pérdidas mediante el beneficio acumulado, el margen comparable
...
-- Posteriormente utilizamos LAG() para comparar cada subcategoría con su propio resultado del año anterior.
...
-- Subcategorías con crecimiento de ventas y deterioro del margen.
