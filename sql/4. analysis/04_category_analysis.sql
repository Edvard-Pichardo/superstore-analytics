/*
Archivo      : 04_category_analysis
Proyecto     : superstore-analytics
Autor        : Cristian Eduardo Pichardo Rico
Descripción  : Análisis comparativo del desempeño comercial de las categorías de productos, considerando
               ventas, beneficio, volumen, participación, rentabilidad y cobertura de datos.
*/
...
-- La participación sobre las ventas totales.
-- La participación sobre la cantidad total vendida.
-- El ranking según ventas.
-- El ranking según beneficio.
-- El ranking según margen comparable.

-- La cobertura de datos se mantiene visible para evitar interpretar las métricas sin considerar los valores
...
-- Vamos a analizar las ventas frente a rentabilidad de los productos.
-- Comparamos la posición de cada categoría según:
-- Ventas totales conocidas.
-- Beneficio total conocido.
-- Margen de beneficio comparable.

-- La diferencia entre los rankings permite detectar categorías cuyo volumen de ventas no se traduce
...
-- Veamos cuál es el impacto de los descuentos frente a la rentabilidad.
-- Agrupamos las líneas de venta por categoría y nivel de descuento para analizar cómo cambia el beneficio.
-- Los intervalos permiten comparar operaciones sin descuento, descuentos bajos, medios y altos.
...
SELECT
    ...
    loss_making_lines,
    -- Porcentaje de líneas con beneficio conocido que terminaron en pérdida.
    ROUND(
        100.0
        *
        loss_making_lines
...
-- Mostramos únicamente las combinaciones de categoría y descuento cuyo beneficio conocido acumulado es negativo.
SELECT
    category,
    discount,
    COUNT(*) AS total_order_lines,
...
-- Veamos el desempeño de cada categoría por año.
-- Posteriormente usaremos LAG() para comparar cada categoría consigo misma respecto al año anterior.
...
-- Verificamos cuántas combinaciones distintas de categoría y año existen en los datos.
