/*
Archivo      : 02_annual_performance
Proyecto     : superstore-analytics
Autor        : Cristian Eduardo Pichardo Rico
Descripción  : Evolución anual del negocio:
               Análisis anual de pedidos, clientes, ventas, beneficios y crecimiento interanual.
*/

USE superstore_analytics;

-- Primero calculamos los indicadores correspondientes a cada año disponible en el conjunto de datos.
WITH rendimiento_anual AS(
    SELECT
        ...
        -- Margen comparable calculado con pedidos cuyas ventas y beneficios están completamente disponibles.
        SUM(
            CASE
                WHEN vos.unknown_sales_lines = 0
...
SELECT
    ...
    -- Un porcentaje sería difícil de interpretar cuando el año anterior tiene beneficios negativos o cercanos a cero.
    ROUND(
...
-- Comprobamos que la agrupación anual conserve todos los pedidos, líneas y métricas comerciales.
SELECT
