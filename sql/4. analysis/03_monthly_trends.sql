...
-- Utilizamos la vista mensual previamente creada y recuperamos mediante LAG() los valores correspondientes al mes anterior.
-- Esto permite calcular variaciones mensuales sin realizar auto-joins sobre la misma vista.
...
SELECT
    ...
    -- Un porcentaje puede resultar engañoso cuando el beneficio anterior es negativo o cercano a cero.
    ROUND(
...
-- Realizamos un análisis por periodo de año. Para ello, agrupamos los mismos meses de diferentes años para
-- identificar patrones estacionales.
-- Por ejemplo:
-- enero 2023 + enero 2024 + enero 2025 + enero 2026 se analizan conjuntamente como "Enero".
...
-- Verificamos cuántos meses del calendario están representados en el conjunto de datos.
SELECT
...
-- Verificamos cuántos años diferentes contribuyen al análisis de cada mes.
SELECT
    order_month,
    CASE order_month
        WHEN 1 THEN 'Enero'
