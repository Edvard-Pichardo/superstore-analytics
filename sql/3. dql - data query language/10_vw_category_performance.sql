...
-- Se utiliza vw_sales_detail porque un mismo pedido puede contener productos pertenecientes a varias categorías.
...
-- Comparamos las categorías del catálogo con las filas generadas en la vista analítica.
SELECT
...
-- Verificamos que ninguna categoría del catálogo haya quedado fuera de la vista.
SELECT
    c.category_id,
    c.category_name
...
-- Comprobamos que la agrupación por categoría conserve todas las líneas y los totales comerciales.
SELECT
