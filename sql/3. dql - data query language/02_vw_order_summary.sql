...
-- Cada fila representa un pedido lógico identificado por  order_key, independientemente de que el order_id original
...
-- Comparamos la cantidad de pedidos del modelo con la cantidad de filas de la vista.
SELECT
...
-- Verificamos que la agregación por pedido conserve la cantidad de líneas y los totales comerciales.
SELECT
