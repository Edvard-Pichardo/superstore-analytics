/*
Archivo      : 03_vw_monthly_performance
...
-- Se utiliza vw_order_summary como fuente porque contiene exactamente una fila por cada pedido lógico.
...
-- Comparamos los periodos distintos de los pedidos con las filas generadas en la vista mensual.
SELECT
    (
...
-- Verificamos que la agrupación mensual conserve todos los pedidos y todas las líneas de venta.
SELECT
...
-- Comparamos las métricas de la vista por pedido con las métricas de la vista mensual.
SELECT
