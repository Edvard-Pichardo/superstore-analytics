...
-- La vista contiene exactamente una fila y utiliza vw_order_summary para conservar el nivel de pedido.
...
-- Verificamos que la vista represente un único resumen ejecutivo del negocio.
SELECT COUNT(*) AS total_filas
FROM vw_business_overview;


-- Comparamos los indicadores principales con vw_order_summary.
SELECT
