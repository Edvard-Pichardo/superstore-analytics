/*
Archivo      : 07_vw_product_performance
...
-- Cada fila representa un producto identificado mediante product_key, incluso cuando su código original haya sido
...
-- Comparamos los productos registrados con las filas generadas en la vista analítica.
SELECT
...
-- Verificamos que ningún producto del modelo haya quedado fuera de la vista. (Debe devolver cero filas)
SELECT
    p.product_key,
    p.source_product_id,
    p.product_name
...
-- Comprobamos que la agrupación por producto conserve todas las líneas y los totales comerciales.
SELECT
