/*
Archivo      : 04_vw_subcategory_performance
...
-- Cada fila representa una subcategoría dentro de su categoría correspondiente.
...
-- Comparamos las subcategorías del modelo con las filas de la vista analítica.
SELECT
...
-- Verificamos que ninguna subcategoría del catálogo haya quedado fuera de la vista. (Debe devolver cero filas)
SELECT
    c.category_name,
...
-- Comprobamos que la agrupación por subcategoría conserve todas las líneas y métricas comerciales.
SELECT
