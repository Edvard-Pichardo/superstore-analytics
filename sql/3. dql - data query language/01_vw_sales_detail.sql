/*
Archivo: 01_vw_sales_detail
Proyecto: superstore-analytics
Autor: Cristian Eduardo Pichardo Rico
Descripción: Vista detallada de ventas:
            Integra las principales tablas del modelo relacional de líneas de venta.
*/

USE superstore_analytics;

-- Cada fila representa un producto incluido en un pedido.
-- Esta vista servirá como fuente base para las consultas analíticas y los indicadores comerciales posteriores.
...
-- La vista debe conservar exactamente una fila por cada registro de order_details.
SELECT
...
-- Comprobamos que ninguna línea se haya duplicado durante las relaciones entre tablas.
SELECT
